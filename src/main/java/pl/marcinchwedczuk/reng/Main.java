...
public class Main {
    ...
    // java -cp ./out/production/reng/ pl.marcinch  wedczuk.reng.Main

    // To run use java -jar target/reng-1.0-SNAPSHOT-jar-with-dependencies.jar.
    ...
    public static void main(String[] args) {
        ...
        while ((line = con.readLine("INPUT? ")) != null) {
            ...
            System.out.println("Matching time: " + (endTime-startTime) + "ms");
            con.flush();
        }
    }
